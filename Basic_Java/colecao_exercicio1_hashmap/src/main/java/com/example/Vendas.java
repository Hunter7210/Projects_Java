...
public class Vendas {
    ...
    public List<Produto> listarProdUsu(String cpf) {
        List<Produto> listaCPF = vendasCPF.getOrDefault(cpf, Collections.emptyList()); //Se caso não encontrar o meu cpf ele adiciona um lista vazia de forma automatica
        return listaCPF; 
    }
